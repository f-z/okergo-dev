...
export function Empty({ category }) {
  ...
  return (
    <Message
      message={"Δεν έχουν δημοσιευθεί αγγελίες για αυτή την κατηγορία εργασιών ακόμα..."}
    />
  )
}
...
export function Private({ category }) {
  ...
  return (
    <Message
      message={"Αυτή η κατηγορία εργασιών είναι πριβέ. Μπορείς να δεις μόνο τις δικές σου αγγελίες."}
    />
  )
}
...
export function Protected({ category }) {
  ...
  return (
    <Message
      message={"Αυτή η κατηγορία εργασιών είναι κλειδωμένη. Δεν μπορείς να δεις τα περιεχόμενά της."}
    />
  )
}
